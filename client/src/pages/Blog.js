        ...
        <div>
            ...
            <div class='relative mx-auto'>
                ...
                <div class='absolute top-2/3'>
                    {/* <p class='ml-7 text-7xl text-orange-600 text-bold '>
                        Be Up-To-Date
                        </p>
            ...
            <div class='grid grid-cols-5 mt-9 mb-9 border-2'>
                ...
                <div class='col-span-2  w-96 border-black  mt-6 mb-9'>
                    <h1 className='font-bold'>Phonography</h1>
                ...
                <div class='col-span-2 mt-6 mb-9'>
                    <h1 className='font-bold'>The Canon Powershot zoom</h1>
                ...
                <div class='col-span-2  w-96 border-black mt-6 mb-9'>
                    <h1 className='font-bold'>360 Panorama</h1>
